...
# outinfo is a vector of about 14000 lines of text. Some lines start on "Band "
...
length(band_lines) # 920 bands, as expected
diff(band_lines) # each descriptor block is 15 lines long

# in line 10 of each block there is a string similar to
...
# In line 9 of each block, there is a long string of numbers separated by
...
s2s_ecmwf_t2m_meta = meta
s2s_ecmwf_t2m = out


save(file='s2s-ecmwf-t2m.Rdata', list=c('s2s_ecmwf_t2m', 's2s_ecmwf_t2m_meta'))
